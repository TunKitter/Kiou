...
class CourseController extends Controller
{
    ...
    public function exploreUser(){
        ...
        $exploreUser = auth()->user()->profession;
      
        $explore_courses = Course::whereIn('category', $exploreUser)->get();

        return view('client.courses.course-explore-user', compact('exploreUser','explore_courses'));
    }
