                                    ...
                                    <div class="profile-content">
                                        <ul class="nav nav-underline nav-justified gap-0">
                                            ...
                                            <li class="nav-item"><a class="nav-link" data-bs-toggle="tab"
                                                    ...
                                                    href="#user-activities">Watch</a></li>
                                            <li class="nav-item"><a class="nav-link" data-bs-toggle="tab"
...
<tr>
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td>
                                                                        {{round($course->meta['total_time']/60)}} hours {{$course->meta['total_time']%60}} minutes
                                                                </td>
                                                            </tr>
<tr>
...
<tr>
    ...
    <link rel="stylesheet" href="{{ asset('assets/css/style.css') }}">
                                                ...
                                                <h6 class="cou-title">
                                                <a class="collapsed" data-bs-toggle="collapse" href="#course_{!!$loop->index!!}" aria-expanded="false">{{$chapter[$key]}} <span>{{count($lesson)}} Lessons</span> </a>
                                                </h6>
                                                <div id="course_{!!$loop->index!!}" class="card-collapse collapse">
                                                    <ul>
                                                        @foreach ($lesson as $item )
                                                        <li>
                                                        <p>{{$item->name}}</p>
                                                        <div>
                                                        <i class="fa-solid fa-play" style="color: #3bc0c3;" onclick="playVideo('{{$item->path}}','{{$item->name}}')"></i>
                                                        </div>
                                                        </li>
                                                        @endforeach
                                                        </ul>
                                                ...
                                                <div class="wrapper-video"> 
                                                    <div class="rect interactive_wrapper" style="width: 20px;height: 20px;background: red;position:absolute;display:none;z-index:100;left:14%;top:15%" onclick="alert(99)"></div>
