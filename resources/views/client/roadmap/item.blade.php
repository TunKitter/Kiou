...
<li>
    ...
    @endphp
<p class="play-intro w-50 d-flex align-items-center justify-content-between flex-wrap" data-bs-toggle="tooltip" data-bs-placement="top" title="{{$course['type_description']}}" > {!!$temp_data_roadmap!!}  <img src="https://picsum.photos/200" style="width:50px"></p>
