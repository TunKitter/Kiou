...
@section('content')
<button class="btn float-end d-block" style="margin-right: 0.5em;border: 1px solid #fc7f50;color: #fc7f50" onclick="location.href='{{route('revision-bookmark-revise')}}'">Revise all</button>
