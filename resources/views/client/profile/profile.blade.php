                            ...
                            <div class="course-group mb-0 d-flex">
                                ...
                                <div class="profile-share d-flex align-items-center justify-content-center">
                                    <label class="btn btn-success" for="avatar"
                                        onclick="document.getElementById('avatar').disabled = false">
                                        Update
                                    </label>
                                    <input onchange="document.getElementById('btn-submit').disabled = false" disabled
                                        type="file" name="avatar" style="display: none" id="avatar"accept="image/*"
                                        form="profile-form">
                            ...
                            <div class="checkout-form personal-address add-course-info ">
                                ...
                                <form action="{{ route('profile') }}" method="POST" id="profile-form"
                                    ...
                                    <div class="row">
                                        <div class="col-lg-6">
                                            <div class="form-group">
                                                <label class="form-control-label">Username <i class="icon feather-edit"
                                                        onclick="un_disabled_input('username')"></i></i></label>
                                                <input type="text" class="form-control infor_input"
                                        ...
                                        <div class="col-lg-6">
                                            <div class="form-group">
                                                <label class="form-control-label">Phone <i class="icon feather-edit"
                                                        onclick="un_disabled_input('phone')"></i></label>
                                                <input type="text" class="form-control infor_input" disabled
                                        ...
                                        <div class="col-lg-6">
                                            <div class="form-group">
                                                <label class="form-control-label">Email <i class="icon feather-edit"
                                                        onclick="un_disabled_input('email')"></i></label>
                                                <input type="text" class="form-control infor_input"
                                            ...
                                            <fieldset class="field-card">
                                                <div class="form-group form-group-tagsinput">
                                                    <input type="text" form="profile-form" data-role="tagsinput"
                                                        ...
                                                        name="professions_input" value="{{ $user_professions }}"
                                                        id="profession_input">
                                    ...
                                    <div class="d-flex justify-content-center  gap-2">
                                        <div class="update-profile">
                                            <button type="submit" class="btn btn-primary border-0" id="btn-submit"
                                                disabled onclick="getProfession()">Update Profile</button>
                                        </div>
                                        @unless (auth()->user()->auth['google'])
                                            <div class="update-profile">
                                                <label class="btn btn-primary text-white" id="update_password"
                                                    onclick="location.href='{{ route('profile-password') }}'">Change
                                                    Password</label>
                                                <style>
