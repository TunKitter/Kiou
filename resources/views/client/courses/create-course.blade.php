                                    ...
                                    <div class="add-course-form">
                                        <form action="#">
                                            <div class="form-group ">
                                                ...
                                                <input type="text" name="title_course" class="form-control is-invalid"
                                                    id="title_course" placeholder="Course Title" />
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="description_course" class="form-control"
                                                    id="des_course" placeholder="Course description" />
                                            ...
                                            <div class="form-group mb-0">
                                                ...
                                                <input type="text" class="form-control" placeholder="10.00"
                                                    id="price_course" name="price_course" />
                                            ...
                                            <div class="form-group mb-0">
                                                ...
                                                <textarea name="course_content" class="form-control" id="content_course"
    ...
    function saveCourse() {
        ...
        fetch('{{ route('handle-upload') }}', {
            ...
            [...document.querySelectorAll('.chapter_video')].map((e, index) => {
                return {
                    [e.querySelector('.chapter_name').innerHTML]: [...e.querySelectorAll('.faq-grid')].map(i => {
                        let formDataAddLesson = new FormData();
                        formDataAddLesson.append('name', i.querySelector('.lesson_name').innerHTML);
                        formDataAddLesson.append('description', i.querySelector('.lesson_description').value);
                        formDataAddLesson.append('category', $(i.querySelector('.lesson_category')).select2('data')[0].id);
