                    ...
                    <div class="container">
                        ...
                        @auth
                            ...
                            <ul class="nav header-navbar-rht">
                                <li class="nav-item">
                                    <a href="course-message.html"><img src="assets/img/icon/messages.svg"
                                            alt="img"></a>
                                </li>
                                ...
                                <li class="nav-item user-nav">
                                    <a href="#" class="dropdown-toggle" data-bs-toggle="dropdown">
                                        <span class="user-img">
                                            <img src="{{ ($image = auth()->user()->image['avatar']) ? (strpos($image, 'http') ? $image : asset('user/avatar/' . $image)) : asset('assets/img/user/avatar.jpg') }}"
                                    ...
                                    <div class="users dropdown-menu dropdown-menu-right"
                                        ...
                                        <div class="user-header">
                                            <div class="avatar avatar-sm">
                                                <img src="{{ $image ? (strpos($image, 'http') ? $image : asset('user/avatar/' . $image)) : asset('assets/img/user/avatar.jpg') }}"
                    ...
                    <div class="course-box trend-box">
                        <div class="product trend-product">
                            ...
                            <div class="product-content">
                                ...
                                <h3 class="title"><a href="course-details.html">The Complete App Design Course -
